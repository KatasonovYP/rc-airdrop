 ...
 */
export function get_hash_proof(test: string, merkle_tree: MerkleTree): (string)[] | undefined;
 ...
 * @returns {boolean}
 */
export function check_proof(test: ClaimNFTParams, merkle_tree: MerkleTree): boolean;
 ...
 * @returns {boolean}
 */
export function check_hash_value(tree: MerkleTree, test_address: string): boolean;
