...
import { CONTRACT_NAME, LP_RAW_SCHEMA, MAX_CONTRACT_EXECUTION_ENERGY, MODULE_REFERENCE } from 'shared/config';
import { WalletConnection } from '@concordium/react-components';
import { ContractInitParameters } from 'shared/model/contract-init-parameters.ts';
